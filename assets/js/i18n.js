...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'home.hero.chip': '📶 Optimized for low-bandwidth connections — works on weak networks worldwide',
      'home.card1.emoji': '🤖',
    ...
    zh: {
      ...
      'home.hero.title': '高性能无刷电机，<br>自有工厂制造并验证',
      'home.hero.sub': '两种方式了解我们 —— <b>与 AI 产品导购对话</b>，或随时随地<b>云参观车间</b>。',
      'home.hero.chip': '📶 专为低带宽连接优化 —— 全球弱网地区均可流畅访问',
      'home.card1.emoji': '🤖',
