...
(function () {
  ...
  var DICT = {
    en: {
      ...
      'home.eyebrow': 'Precision BLDC Engineering',
      'home.cta1': 'Talk to our AI guide',
      'home.cta2': 'Tour the factory',
      'home.stat1': 'application fields',
      'home.stat2': 'in-line QC steps',
      'home.stat3': 'working-day engineer reply',
      'home.stat4': 'bilingual guide',
      'home.card1.go': 'Start the conversation',
      'home.card2.title': 'Virtual Factory Tour',
      'home.card2.body': 'See our winding stations, CCD vision inspection, burn-in room and packing area — recorded walkthroughs you can watch from anywhere.',
    ...
    zh: {
      ...
      'home.eyebrow': '精密无刷电机工程',
      'home.cta1': '与 AI 导购对话',
      'home.cta2': '云参观工厂',
      'home.stat1': '大应用场景',
      'home.stat2': '道关键质检工序',
      'home.stat3': '个工作日工程师响应',
      'home.stat4': '双语导览',
      'home.card1.go': '开始对话',
      'home.card2.title': '云参观工厂',
      'home.card2.body': '走进绕线车间、CCD 视觉检测工位、老化房和打包区 —— 随时随地观看真实产线。',
      'home.card2.go': '进入车间',
      'footer.contact': '联系方式',
